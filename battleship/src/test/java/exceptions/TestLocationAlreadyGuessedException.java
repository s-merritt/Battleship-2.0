...
import exceptions.TestLocationAlreadyGuessedException;

/**
 * Unit tests objects.Coordinate
 */
public class TestLocationAlreadyGuessedException extends TestCase {
   ...
   */
  public TestLocationAlreadyGuessedException(String testname) {
    super(testname);
  }
